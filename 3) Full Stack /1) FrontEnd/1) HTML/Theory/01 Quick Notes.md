...
==> Empty Element 
--> Elements with no content (that do not print anything) are called empty element 
...
--> Placeholder is used for giving a hint about what kind of information to enter
