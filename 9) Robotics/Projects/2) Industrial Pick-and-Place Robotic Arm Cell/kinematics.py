...
JOINT_LIMITS_RAD = [
    ...
    (-np.pi / 2, np.pi / 2),   # joint 1: shoulder (from horizontal -- MUST allow
                                # dipping below horizontal, not just [0, pi], or
                                # the arm can never reach down to table/conveyor
                                # height to actually pick anything up)
